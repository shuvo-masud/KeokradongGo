...
const TRUST_STEPS = [
  { num: '০১', title: 'স্থানীয় লিস্টিং (Local Listing)', desc: 'বিক্রেতারা তাদের অঞ্চলের খাঁটি ঐতিহ্যবাহী পণ্য যেমন—রাজশাহীর আম, টাঙ্গাইলের শাড়ি বা চট্টগ্রামের শুঁটکی মাছ, অরিজিনাল জেলা উল্লেখ করে লিস্টিং করেন।' },
